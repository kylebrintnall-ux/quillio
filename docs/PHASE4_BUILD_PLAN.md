...
- **Server-side (Railway / REST):** OAuth, folder creation, project Figma file creation at brief time, project record-keeping, design.md generation, serving approved copy to the plugin, finished-asset export into the Drive campaign folder at handoff.
...
**1.5 Master template duplication + folder.**
...
## Stage 2 — Project Figma file creation at brief time

**2.1 Auto-create the project Figma file.**
...
| 1 | Schema, OAuth, token refresh, template duplication, connect UI | Server-side |
| 2 | Auto-create project Figma file at brief time; cross-link | Server-side (shared pipeline) |
